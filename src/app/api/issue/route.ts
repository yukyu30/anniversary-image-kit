...
/** 周年数は固定（ユーザーに入力させず、config の値を署名に埋め込む） */
export const ANNIVERSARY_YEARS = siteConfig.anniversary.years;

/** 記念画像の生成受付終了（config の期限まで） */
export const GENERATION_DEADLINE = Date.parse(siteConfig.generation.deadline);
