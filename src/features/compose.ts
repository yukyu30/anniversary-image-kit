...
/** フレーム識別子（config.frames の value） */
export type FrameColor = string;

export const HASHTAG = siteConfig.hashtag;

/** チェキ余白（写真幅に対する割合）: 上・左右 / 下 */
export const CHEKI = siteConfig.cheki;

const FRAME_SRC: Record<string, string> = Object.fromEntries(
